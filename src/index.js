...
<h3>Audio</h3>
<p>This recording was made on Feb. 22, 2021, on the fourth sol (Martian day) by the SuperCam instrument on NASA’s Perseverance rover after deployment of the rover’s mast.</p>
<p>It provides a different overall sound than the SuperCam audio recording from the mission’s first sol.</p>
<p>Some wind can be heard, especially around 20 seconds into the recording.</p>
<p>Rover background sounds have been removed.</p>
<p>Credit: NASA/JPL-Caltech/LANL/CNES/CNRS/ISAE-Supaero</p>
<p>Source: https://mars.nasa.gov/resources/25714/perseverance-rovers-supercam-records-wind-on-mars/</p>
`
textarray[7]=`
...
`
textarray[9]=`
<h3>Van Zyl Overlook</h3><p>NASA’s Perseverance Mars rover used its Mastcam-Z stereo imaging system to capture this 360-degree panorama of “Van Zyl Overlook,” where the rover was parked for 13 days as the Ingenuity helicopter performed its first flights.
Van Zyl Overlook is named after the late NASA/JPL Director for Solar System Exploration Jakob J. Van Zyl, who played a major role in the advocacy and development of many NASA robotic solar system missions.
The panorama is made up of 992 individual right-eye Mastcam-Z images stitched together.
The images were taken between April 15 and 26, 2021, or the 53rd and 64th Martian days, or sols, of the mission.
...
A few small patches of near-field sand had been covered by parts of Perseverance when the right-eye Mastcam-Z images were taken; those gaps were filled with images of the same sandy patches taken by the Mastcam-Z left-eye camera at the same time, or from the earlier navigation camera images.
Imaging coverage of the sky has also been digitally smoothed and expanded based on the actual sky color observed as the panorama was being acquired on Mars.</p>
<h3>Audio</h3>
<p>Listen to 16 minutes of raw, unfiltered sounds of the Perseverance Mars rover traveling in Jezero Crater.
The noise generated by the interaction of the rover’s wheels and suspension with the surface can be heard, along with a high-pitched scratching noise.</p>
<p>Credit NASA/JPL-Caltech</p>
<p>Source: https://mars.nasa.gov/resources/25731/sounds-of-perseverance-mars-rover-driving-sol-16-16-minutes</p>

`
textarray[10]=`
<h3>Village Outcrop</h3><p></p>
<p>“Village” Outcrop 110-mm Mosaic within Séítah, Sols 214-215 (Sep. 25-26, 2021).</p>
<p>Right eye panorama, natural color.</p>
<p>Source: https://mastcamz.asu.edu/mastcam-zs-360-panorama-collection/</p>
<h3>Audio</h3>
<p>This is the first acoustic recording of laser impacts on a rock target on Mars from March 2, 2021, the 12th sol (Martian day) from Perseverance’s SuperCam instrument.</p>
<p>The sounds of 30 impacts are heard, some slightly louder than others.</p>
<p>Variations in the intensity of the zapping sounds will provide information on the physical structure of the targets, such as its relative hardness or the presence of weathering coatings.</p>
<p>The target, Máaz (“Mars” in Navajo), was about 10 feet (3.1 m) away.</p>
<p>Credit NASA/JPL-Caltech/LANL/CNES/CNRS/ISAE-Supaero</p>
<p>Source: https://mars.nasa.gov/resources/25715/first-acoustic-recording-of-laser-shots-on-mars</p>
`
textarray[11]=`
<h3>Hagwallow Flats and Skinner Ridge</h3><p>This beautiful mosaic is the most detailed image ever taken on the surface of Mars.
...
NASA's Perseverance Mars rover is now exploring a really important part of Jezero crater.
Around 3.5 billion years ago, a river flowed into Lake Jezero, depositing mud and sand on the crater floor, forming an ancient delta.
...
In this panorama, an area called Hogwallow Flats is visible, as is Skinner Ridge, where two rock core samples were taken.</p>
